    ...
    <div className="min-h-screen bg-blue-900 flex flex-col items-center justify-center p-8 my-12">
      ...
      <div className="max-w-6xl w-full mt-8 text-center">
        <p className="text-2xl text-white font-semibold">
          Join us at ICSTEET and unlock the opportunity to publish your research in reputed <br/>Scopus / SCIE indexed journals.
        </p>
      </div>
    </div>
  );
